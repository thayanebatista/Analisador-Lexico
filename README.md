...
# **Funcionalidades**
    Construção da tabela de palavras reservadas.
    Implementar analisador léxico como rotina: Quando invocado retorna
    dois valores: a cadeia lida e o seu token correspondente.
    Detecção e Tratamento de Erros: Programa principal deve invocar a
    rotina do analisador léxico até que todo o programa tenha sido
    consumido.
    Implementar os autômatos que representam as expressões regulares
    da linguagem.
